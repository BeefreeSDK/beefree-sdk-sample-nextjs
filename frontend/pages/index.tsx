      ...
      <Box>
        <Grid container spacing={3}>
          <Grid item xs={12} lg={12}>
            <DashboardCard title="Example Card Title">
              <Typography>All the data on this page is not real. This is just meant to simulate how a host app might look.</Typography>
            </DashboardCard>
          </Grid>
